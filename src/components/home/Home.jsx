        ...
        <>
               ...
               <section id='hero' className='w-[90%] m-auto flex lg:flex-row flex-col justify-between items-center gap-28 py-20 sm:px-20'>
                <div className='flex flex-col justify-center items-start gap-8'>
                    ...
                    <p data-aos="xoom-in" data-aos-delay="400" className='font-ubuntu text-[20px] text-slate-700'>We craft outstanding brands, products, web apps, <br></br>  and websites for startups and enterprises.</p>
