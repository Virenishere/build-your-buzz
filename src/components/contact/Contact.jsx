            ...
            <div data-aos="zoom-in" data-aos-delay="400" className="lg:w-[50%] w-full flex flex-col justify-center items-start gap-8 bg-black lg:p-16 p-8 rounded-3xl">
                ...
                <div id="form-box" className="w-full bg-transparent flex flex-col justify-center items-center gap-4">
                    ...
                    <div className="w-full flex justify-center items-start gap-4">
                        <input type="email" placeholder="Enter your valid email here" className="w-full bg-slate-900 px-6 py-4 rounded-lg border-none font-ubuntu" />

                        <input type="number" placeholder="Enter your mobile number" className="w-full bg-slate-900 px-6 py-4 rounded-lg border-none font-ubuntu" />
                    </div>

                    <textarea name="" id="" className="w-full bg-slate-900 px-6 py-4 rounded-lg border-none font-ubuntu" placeholder="Enter your message" rows="4"></textarea>
